...
<head>
    ...
    <link rel="stylesheet" href="/src/styles/acerto.css">
    <link rel="stylesheet" href="{{ asset('/src/css/acerto.css') }}">
                ...
                <div class="col apoio-externo">
                    ...
                    <div class="container-infos-code">
                        <div class="status">
                            ...
                            <p><span id="errado">{{ $status }}</span></p>
                        </div>
                        <div class="time">
                            <p id="info-name">Tempo</p>
                            <span class="icon"><i class="bi bi-hourglass-split"></i></span>
                            <p id="time-color">{ $time }s</p>
                        </div>
                        
                        <div class="memory">
                            <p id="info-name">Memória</p>
                            <span class="icon"><i class="bi bi-memory"></i></span>
                            <p id="memory-color">{ $memory } bytes</p>
                        </div>
                    </div>
                </div>
                <div class="col apoio-proprio" style="width: 100%; overflow: auto;">
                    <div class="container-info">
                        <h1 class="error-message">Ops! Ocorreu um Erro :(</h1>
                        <img src="https://p.productioncrate.com/stock-hd/effects/footagecrate-red-error-icon-prev-full.png" alt="" width="500px">
                        ...
                        <a href="{{ url('/') }}" class="btn botao-tentar">Tentar Novamente</a>
                    </div>
                </div>
            </div>
