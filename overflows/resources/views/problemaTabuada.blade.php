...
<div class="principal">
    <div class="panel" id="panel1">
        <div class="info-questao">
            <div class="titulo"><span>Tabuada</span></div>
            <div class="autor-info">
                <i class='bx bxs-user'></i><span id="nome-autor">Diogo Bruno</span>,
                <br><img src="/src/imgs/brasil.png" alt="" width="24px"> <span id="local">Brasil</span>
            </div>
        </div>
        <div class="desafio">
            <p>Bino está aprendendo a multiplicar números e gostaria da sua ajuda para apresentar a tabuada de um determinado valor inteiro X.</p>
            <p><b>Entrada:</b> A entrada consiste em uma única linha contendo o valor inteiro X.</p>
            <p><b>Saida:</b> A saída consiste de 10 linhas. A i-éssima linha contem a mensagem "x * i = valor", onde x é o valor de X, i representa o identificador da linha e o 'valor' corresponde a multiplicação de X∗i.</p>
        </div>
            ...
            <table class="table table-dark table-bordered table-borderless">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>
                            1 * 1 = 1 <br> 1 * 2 = 2 <br> 1 * 3 = 3 <br> 1 * 4 = 4 <br> 1 * 5 = 5 <br> 1 * 6 = 6 <br> 1 * 7 = 7 <br> 1 * 8 = 8 <br> 1 * 9 = 9 <br> 1 * 10 = 10
                        </td>
                    </tr>
                </tbody>
            </table>
