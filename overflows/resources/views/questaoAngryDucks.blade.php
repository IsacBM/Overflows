...
<head>
    ...
    <title>Overflows - AngryDucsk!</title>
...
<div class="panel" id="panel1">
                <div class="info-questao">
                    <div class="titulo"><span>Angry Ducks</span></div>
                ...
                <div class="desafio">
                    <p>Em uma terra distante existem duas cidades, a Nlogônia onde vivem os Nlogoneses, e Ducklogônia onde vivem seus vizinhos os Duckneses, já à algum tempo estas duas cidades estão em guerra e agora em uma tentativa de ganhar a guerra os Duckneses pretendem atacar a cidade da Nlogônia com um bodoque que atira patos, porem para que não haja erro eles pediram que você construa um programa que dados os valores da altura do bodoque (h), os pontos onde inicia (p1) e onde termina (p2) a cidade da Nlogônia, o ângulo do disparo ( α) e a velocidade do lançamento, calcule se o projetil atingira o alvo.</p>
                    <div class="img-questao" style="text-align: center;" ><img width="70%" style="margin: 0%;" src="/src/imgs/img-angry.jpg" alt="img" ></div> <br>
                    <p>Para os cálculos assuma que a aceleração da gravidade é g = 9.80665 e que π = 3.14159.</p>
                    <p>O final do arquivo de entrada é determinado por EOF.</p>
                    <p></p><b>Saida:</b> Para cada disparo, seu programa deve imprimir uma única linha no seguinte formato, “X -> DUCK” para quando o pato acertar a Nlogônia ou “X -> NUCK” quando o pato não acertar a Nlogônia, onde X eh a distancia máxima que o projetil atingiu até chegar ao chão (Y=0). X deve ser impresso com 5 casas decimais.</p>
                </div>
                <div class=" row entrada-e-saida">
                    <table class="table table-dark table-bordered table-borderless">
                        ...
                        <tbody>
                          <tr>
                            <td>2.1 <br> 368 380 <br> 3 <br> 42.3 60 <br> 30 55 <br> 44 60.876842</td>
                            <td>367.76208 -> NUCK <br> 270.72675 -> NUCK <br> 379.83781 -> DUCK</td>
                          </tr>
                        </tbody>
                      </table>
